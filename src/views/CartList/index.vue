        ...
        <table>
          ...
          <tbody>
            <tr v-for="i in cartStore.cartList" :key="i.id">
              <td>
                <!-- //传入购物车的商品的selected属性就是默认为true -->
                <!-- <el-checkbox :model-value="i.selected" @change="(selected) => singleCheck(i, selected)" /> -->
                <el-checkbox v-model="i.selected" @change="cartStore.updateCartItemStore(i)" /> 
              </td>
              <td>
                <div class="goods">
              ...
              <td class="tc">
                <el-input-number v-model="i.count" :min="1" @change="cartStore.updateCartItemStore(i)" />
              </td>
              <td class="tc">
