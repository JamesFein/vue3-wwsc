...
const getPayInfo = async () => {
    console.log("The query looks like this:",route.query)
    console.log("query.orderId, which is alwo orderId is:",route.query.orderId)
    const res = await getOrderAPI(route.query.orderId)
    payInfo.value = res.result
    console.log('payInfo', payInfo.value)
    console.log('payInfo.value.countdown', payInfo.value.countdown)
